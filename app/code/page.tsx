  ...
  return (
    <>
      <section className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 mt-[var(--space-32)] sm:mt-[var(--space-16)] overflow-x-hidden">
        ...
        <ul className="grid gap-[var(--space-4)] mt-[var(--space-8)] grid-cols-1 lg:grid-cols-2 max-w-[1200px]">
          {code
            .filter(
            ...
            .map((item) => (
              <li
                key={item.id}
                className="border border-[#333] p-[var(--space-8)] min-h-[250px] rounded-[var(--radius-lg)] flex flex-col transition-[var(--transition-base)] hover:shadow-[var(--shadow-lg)]"
              >
                <div
